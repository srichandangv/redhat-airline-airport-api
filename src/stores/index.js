...
var client_1 = __importDefault(require("../datagrid/client"));
var airport_1 = require("../entity/airport");
var log_1 = __importDefault(require("../log"));
var getClient = client_1.default(config_1.DATAGRID_AIRPORT_DATA_STORE);
function getAirportInCache(iata) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    client = _a.sent();
                    return [4, client.get(iata)];
                case 2:
                    data = _a.sent();
                    if (data) {
                        try {
                            return [2, airport_1.Airport.fromJSON(JSON.parse(data))];
                        }
                        catch (_b) {
...
function upsertAirportInCache(airport) {
    return __awaiter(this, void 0, void 0, function () {
        var data, client;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2, client.put(airport.iata, JSON.stringify(data))];
            }
        });
    });
}
